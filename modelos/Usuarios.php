  ...
  //conexion a la base de datos
   ...
   class Usuarios extends Conectar {
      ...
      //FIN PERMISOS DEL USUARIO   
       ...
       //listar los usuarios, 1. Primera funcion hicimos
        ...
        //metodo para registrar usuario, 2. Segunda funcion hicimos
   	    public function registrar_usuario($nombre,$apellido,$cedula,$telefono,$email,$direccion,$cargo,$usuario,$password1,$password2,$estado,$permisos){
             ...
             values(null,?,?,?,?,?,?,?,?,?,?,now(),?);"; //el id autoincrementable es null
        ...
        //metodo para editar usuario 3. Tercera funcion que hacemos
   ...
   //si el id_usuario NO tiene registros asociados en las tablas compras y ventas entonces se puede editar todos los campos de la tabla usuarios
     if(is_array($usuario_compras)==true and count($usuario_compras)==0 and is_array($usuario_ventas)==true and count($usuario_ventas)==0){
                ...
                ";
                  //echo $sql; //Imprimir consulta para debug
        ...
        //mostrar los datos del usuario por el id      4. Este es la cuarta funcion que hacemos
          ...
          return $resultado=$sql->fetchAll();
   	    ...
   	    //editar el estado del usuario, activar y desactiva el estado   5. Quinca funcion que hacemos
   	    ...
   	    //valida correo y cedula del usuario 6. Sexta funcion que hacemos
